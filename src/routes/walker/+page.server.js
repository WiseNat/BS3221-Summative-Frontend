import { WALKER_REGISTER_URL, WALKER_REGISTER_SECRET } from '$env/static/private';
...
export const actions = {
  register: async ({ request }) => {
	...
	const response = await fetch(WALKER_REGISTER_URL, {
		method: "POST",
		headers: {
			"x-api-key": WALKER_REGISTER_SECRET,
